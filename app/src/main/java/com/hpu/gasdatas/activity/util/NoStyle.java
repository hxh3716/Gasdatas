...
public class NoStyle extends LineStyle {
        ...
        private static  int  defaultLineColor = Color.parseColor("#003366");
        ...
        public NoStyle(float width, int color) {
            this.width = width;
            this.color = color;
        }
        public NoStyle(Context context, float dp, int color) {
        ...
        public NoStyle setWidth(float width) {
            this.width = width;
            return this;
        }
        public NoStyle setWidth(Context context, int dp) {
            this.width = DensityUtils.dp2px(context,dp);
            return this;
        }
        ...
        public NoStyle setFill(boolean fill) {
            isFill = fill;
            return this;
        }

        public NoStyle setColor(int color) {

            this.color = color;
            return this;
        }

        public NoStyle setEffect(PathEffect effect) {
            this.effect = effect;
            return this;
        }
